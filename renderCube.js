...
import { FaceColors } from './three/build/three.module.js';
...
const piece_geometry = new THREE.BoxGeometry(0.88,0.88,0.88);

const edges = new THREE.EdgesGeometry( piece_geometry );
...
for(let i = 0; i<28;i++){
    ...
    while(size--) materialz[size] = new THREE.MeshBasicMaterial( { color: black } );    
    if(i < 9){
    ...
    pieces.push(new THREE.Mesh( piece_geometry, materialz));
}
